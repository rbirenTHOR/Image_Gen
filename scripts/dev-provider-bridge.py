...
class Handler(BaseHTTPRequestHandler):
 ...
 def handle_proxy(self):
  ...
  if u.scheme!='https' or not (u.hostname in ['api.openai.com','queue.fal.run','fal.media'] or (u.hostname or '').endswith('.fal.media') or (u.hostname or '').endswith('.falusercontent.com')):self.send_error(403);return
