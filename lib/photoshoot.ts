...
export const photoshootShots: PhotoshootShot[] = [
  ...
  },
  {
    ...
    direction: "FULL-HEIGHT VERTICAL STORY. Compose natively at 9:16 using a 35mm lens at chest height, f/4. Exactly one reference adult bends slightly to pick up their day bag from a camp chair, preparing for an outing. Keep all other adults, children and animals outside this particular frame, even if present in the style reference. Include natural head-to-foot body scale, a readable hand-to-bag interaction and a partial supported RV wall as midground context. Keep the face, hands and bag in the central three-quarters of the image so screen overlays can avoid them; the entire frame remains real scenery. This is one still photograph, not a video storyboard. No new equipment, open doors or invented interior.",
  },
  {
    id: "breakfast",
