...
export const rvViewGuard = "RV VIEW LIMITS TAKE PRIORITY over any requested lens, camera height, angle or creative direction. Preserve the chosen source view's side, front-to-side perspective, roof visibility and fixed distances between the door, windows, axles and front cap. Never rotate, mirror, foreshorten, widen or compress the vehicle to fit. Change framing, output shape, people, activity and foreground instead. A tight lifestyle photo may crop the supported RV wall. When RV presence is required, adjust the activity and framing within the supported view to keep it visible. Never infer an unseen side, roof, interior or opened feature. Never combine different source angles into one vehicle. RV presence does not require logo visibility: logos may be cropped, naturally occluded or softened by depth of field. Do not move, enlarge, invent or artificially sharpen branding to prove identity. Preserve any markings that are naturally visible without making them the compositional target. Let people and activity lead lifestyle frames; reserve product prominence for assigned hero or product shots.";
